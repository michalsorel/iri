...
disp('Method comparison for irregular sampling, overlap 0.5m. Sayers cannot be used.');
...
figure;plot_iri(IRI2,road_profile);title('Sroubek & Sorel, irregular sampling, overlap 0.5m');
