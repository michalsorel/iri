...
disp('Method comparison for regular sampling, no overlap.');
...
figure;plot_iri(IRI2,road_profile);title('Sroubek & Sorel, regular sampling, no overlap');
figure;plot_iri(IRI0,road_profile);title('Sayers, regular sampling, no overlap');
